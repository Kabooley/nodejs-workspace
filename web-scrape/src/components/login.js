 ...
 *
 * ***********************************************************/
var selectors_1 = require("../constants/selectors");
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    console.log('Typing...');
                    // Fill login form.
                    return [4 /*yield*/, page.type(selectors_1.selectors.usernameForm, username, typeOptions)];
                case 2:
                    // Fill login form.
                    _b.sent();
                    return [4 /*yield*/, page.type(selectors_1.selectors.passwordForm, password, typeOptions)];
                case 3:
                    _b.sent();
                    return [4 /*yield*/, Promise.all([
                            page.waitForNavigation({ waitUntil: ["networkidle2"] }),
                            page.click(selectors_1.selectors.loginButton)
                        ])];
                case 4:
                    response = (_b.sent())[0];
