...
exports.createWorkerSession = void 0;
/**
 ...
 *
 * */
var createWorkerSession = function (page) { return __awaiter(void 0, void 0, void 0, function () {
    var client, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, client.send("Network.setBypassServiceWorker", { bypass: true })];
            case 3:
                // サービスワーカへのバイパスを有効化します
                _a.sent();
                ...
                client.on('Network.receiveMesageFromTarget', function () { return console.log("Network.receiveMesageFromTarget"); });
...
exports.createWorkerSession = createWorkerSession;
